...
public class FindRidesGUI extends JFrame {
	...
	private List<XMLGregorianCalendar> datesWithRidesCurrentMonth = new Vector<XMLGregorianCalendar>();
	...
	public FindRidesGUI()
	{
		...
		jComboBoxDestination.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				...
				List<XMLGregorianCalendar> listDates;


				datesWithRidesCurrentMonth=facade.getThisMonthDatesWithRides((String)jComboBoxOrigin.getSelectedItem(),(String)jComboBoxDestination.getSelectedItem(),UtilDate.newDateXMLGregorianCalendar(jCalendar1.getDate()));
				
				Iterator<XMLGregorianCalendar> it=datesWithRidesCurrentMonth.iterator();
				while (it.hasNext())
			...
			public void propertyChange(PropertyChangeEvent propertychangeevent)
			{
				...
				else if (propertychangeevent.getPropertyName().equals("calendar"))
				{
					...
					try {
						...
						BLFacade facade = MainGUI.getBusinessLogic();
						List<Ride> rides=facade.getRides((String)jComboBoxOrigin.getSelectedItem(),(String)jComboBoxDestination.getSelectedItem(),UtilDate.newDateXMLGregorianCalendar(UtilDate.trim(jCalendar1.getDate())));
	...
	public static void paintDaysWithEvents(JCalendar jCalendar,List<XMLGregorianCalendar> datesWithEventsCurrentMonth, Color color) {
		...
		for (XMLGregorianCalendar d:datesWithEventsCurrentMonth){

			
			Date date = d.toGregorianCalendar().getTime();
